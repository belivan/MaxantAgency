...
export function ComparisonRequestHero() {
  const scrollToForm = () => {
      ...
      <div className="container relative z-10 px-4 py-20 mx-auto max-w-5xl">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium">Competitive Website Analysis</span>
          </motion.div>
          ...
          >
            Get a comprehensive AI-powered analysis comparing your website to top competitors in your industry.
            <br />
            <span className="text-foreground font-medium">
              Know exactly where you stand—and how to win.
            </span>
          </motion.p>
          ...
          >
            No credit card required • 24-hour turnaround • Compare against any competitor
          </motion.p>
        </motion.div>
      </div>
