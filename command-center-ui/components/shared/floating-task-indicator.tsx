...
export function FloatingTaskIndicator() {
  ...
  return (
    <>
      {/* Expandable Panel */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-[28rem] max-h-[32rem] overflow-hidden rounded-lg border bg-card shadow-lg flex flex-col">
          {/* Tab Header */}
          <div className="border-b bg-muted/50 px-2 py-2 flex items-center justify-between">
          ...
          {/* Tab Content */}
          <div className="flex-1 overflow-hidden min-h-0 max-h-[26rem]">
            {activeTab === 'tasks' ? (
              /* Tasks Panel */
              <div className="h-full flex flex-col overflow-hidden">
                ...
                {/* Task List */}
                <div className="flex-1 overflow-y-auto max-h-[36rem]">
                  {tasks.length === 0 ? (
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        >
          <MaxantLogo className={cn('w-6 h-6', hasActiveTasks && 'animate-spin')} />
        </Button>
