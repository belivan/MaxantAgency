...
/**
 * Prospecting AI Model Selector Component
 * Allows selection of AI models for each prospecting module
 */
...
export interface ProspectingModule {
  value: string;
  label: string;
  description: string;
  defaultModel: string;
...
interface ProspectingModelSelectorProps {
  modules: readonly ProspectingModule[];
