 ...
 * Resume a paused campaign - verifies ownership then calls orchestrator
 */
export async function PUT(
  ...
  try {
    ...
    // Optionally notify orchestrator about the resume
    try {
      await fetch(`${ORCHESTRATOR_API}/api/campaigns/${campaignId}/resume`, {
        method: 'PUT',
      });
    } catch {
