/**
 * Test Batch Intelligent Multi-Page Analysis
 * Analyzes 10 prospects using the new /api/analyze endpoint
 */
...
async function testBatchAnalysis() {
  console.log('🧪 Testing Batch Intelligent Multi-Page Analysis\n');
  console.log('='.repeat(60));

  try {
    // Fetch 10 prospects
    console.log('\n📊 Fetching 10 prospects from database...');
